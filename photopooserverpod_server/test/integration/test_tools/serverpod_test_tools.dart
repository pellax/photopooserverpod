...
class _AuthEndpoint {
  ...
  _i3.Future<Map<String, dynamic>?> validateToken(
    _i1.TestSessionBuilder sessionBuilder,
    String token,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _FriendsEndpoint {
  ...
  _i3.Future<void> createFriendship(
    _i1.TestSessionBuilder sessionBuilder,
    _i4.User friendsof,
    _i4.User friendsby,
  ) async {
  ...
  _i3.Future<void> deleteFriendship(
    _i1.TestSessionBuilder sessionBuilder,
    _i4.User friendof,
    _i4.User friendsby,
  ) async {
...
class _RoomsEndpoint {
  ...
  _i3.Future<void> example(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'rooms',
...
class _UsersEndpoint {
  ...
  _i3.Future<List<_i5.Friends>> getFriendsbyUser(
    _i1.TestSessionBuilder sessionBuilder,
    _i4.User user,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'users',
        method: 'getFriendsbyUser',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'users',
          methodName: 'getFriendsbyUser',
          parameters: _i1.testObjectToJson({'user': user}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
