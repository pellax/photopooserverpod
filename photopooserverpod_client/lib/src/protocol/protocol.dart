...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    t ??= T;
    if (t == _i2.DietTypeEnum) {
      return _i2.DietTypeEnum.fromJson(data) as T;
    }
    if (t == _i3.Example) {
    ...
    if (t == _i1.getType<_i2.DietTypeEnum?>()) {
      return (data != null ? _i2.DietTypeEnum.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'DietTypeEnum') {
      return deserialize<_i2.DietTypeEnum>(data['data']);
    }
